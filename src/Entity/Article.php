...
class Article
{
    ...
    public function getImageAgencyPost(): ?string
    {
        return $this->imageAgencyPost;
    }

    public function setImageAgencyPost(string $imageAgencyPost): self
    {
        $this->imageAgencyPost = $imageAgencyPost;
